...
public class CustomListeners extends BaseClass implements ITestListener,ISuiteListener {
	...
	public void onTestFailure(ITestResult arg0) {
		...
		extentObject.log(LogStatus.FAIL, arg0.getName().toUpperCase()+" Failed with exception : "+arg0.getThrowable());
		extentObject.log(LogStatus.INFO, extentObject.addScreenCapture(Utilities.screenshotName));
		
		rep.endTest(extentObject);
		rep.flush();
	...
	public void onTestSkipped(ITestResult arg0) {
		...
		extentObject.log(LogStatus.SKIP, arg0.getName().toUpperCase()+" Skipped the test as the Run mode is NO");
		rep.endTest(extentObject);
		rep.flush();
	...
	public void onTestStart(ITestResult arg0) {
		...
		extentObject = rep.startTest(arg0.getName().toUpperCase());
	...
	public void onTestSuccess(ITestResult arg0) {
		...
		extentObject.log(LogStatus.PASS, arg0.getName().toUpperCase()+" PASS");
		rep.endTest(extentObject);
		rep.flush();
